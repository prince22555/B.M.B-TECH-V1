...
✞ Enter your whatsapp number with the country code e.g;  255741752020 then tap submit 
✞ B.M.B-MD owner , *B.M.B* ,will send you the code immediately.Copy the code and whatsapp will bring a notification 
✞Tap on the notification and paste the code that B.M.B md owner sent you.
✞ After a successful login B.M.B-MD owner 😂 B.M.B will send you a *session id* .some will wonder where the hell is that session ,,,...It is just right at your inbox /dm {your own number for whatsappp} 😂
✞Copy the Session id {the one with unreadable codes and long copy it and send it to your deployer or deploy
     𝐇𝐎𝐖 𝐓𝐎 𝐃𝐄𝐏𝐋𝐎𝐘 B.M.B 𝐌𝐃
✔ Now check on B.M.B-MD  repository in github fork and give a star to this repository before doing anything 🌟or else B.M.B-MD owner won't allow you to deploy his bot💀.
...
✔Now click on this devs number and give B.M.B-MD owner credits https://wa.me/+255741752020
╰────────────────────☆`;
let menuMsg = `
     𝐑𝐞𝐠𝐚𝐫𝐝𝐬 B.M.B`;
   var lien = mybotpic();
